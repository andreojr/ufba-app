...
/** Google Classroom app icon, verbatim from the official `classroom.svg` mark. */
export function ClassroomIcon({ size = 22 }: { size?: number }): JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 578.9 500" fill="none">
      <Defs>
        <LinearGradient
          id="classroom-corner-shadow"
      ...
      />
      <Path fill="url(#classroom-corner-shadow)" d="M460.3,447.4H341.9l52.6,52.6h118.3L460.3,447.4z" />
