...
/** Moodle app icon, verbatim from the official cropped `Moodle.svg` mark. */
export function MoodleIcon({ size = 22 }: { size?: number }): JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 128 128" fill="none">
      <Defs>
        ...
        >
          ...
          <Stop offset="0.043" stopColor="#F9A538" />
          <Stop offset="0.112" stopColor="#F89D31" />
          <Stop offset="0.227" stopColor="#F89A2F" />
          <Stop offset="0.528" stopColor="#F7922D" />
        ...
        >
          ...
          <Stop offset="0.124" stopColor="#757578" />
          <Stop offset="0.279" stopColor="#575658" />
          <Stop offset="0.44" stopColor="#403E3F" />
          <Stop offset="0.609" stopColor="#302D2E" />
          <Stop offset="0.788" stopColor="#262223" />
      ...
      />
      <Path
        fill="url(#moodle-icon-d)"
        d="M2.178 47.08c29.932-18.031 46.77-21.43 81.634-25-40.478 31.969-41.499 25-81.634 25"
      />
      <Path stroke="#4A4A4C" strokeWidth={0.5} fill="none" d="M83.812 22.246L51.667 45.545" />
      <Path opacity={0.23} fill="#231F20" d="M45.545 34.66c.34 3.744-.511-3.572 0 0" />
      <Path stroke="#A8ABAD" strokeWidth={0.5} fill="none" d="M2.178 47.08l49.489-1.535" />
      <Path
        stroke="#F16922"
        strokeWidth={0.5}
        fill="none"
